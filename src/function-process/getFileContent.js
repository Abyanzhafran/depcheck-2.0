    ...
    if (stat.isDirectory()) {
      ...
      if (filename === "package-lock.json") {
        ...
        let contentData = {
          ...
          optionalDependencies: jsonData.optionalDependencies
            ? Object.values(jsonData["optionalDependencies"])
            : "",
          peerDependencies: jsonData.peerDependencies
            ? Object.values(jsonData["peerDependencies"])
            : "",
        };
...
function getInstalledPackageJsonDependencies(dir) {
  ...
  files.forEach((filename) => {
    ...
    if (filename === "node_modules") {
      ...
      packageContent = packageContent.concat(
        getInstalledPackageJsonDependencies(filePath)
      );
    }
  });
